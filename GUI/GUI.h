...
public:
	...
	void DrawEllipse(Point P1, Point P2, GfxInfo RectGfxInfo, bool selected) const;  //Draw an Elipse
	void DrawHexagon(Point P1, Point P2, GfxInfo RectGfxInfo, bool selected) const;
	//void DrawHexagon(Point P1, int length, GfxInfo RectGfxInfo, bool selected = false) const;  //Draw an Elipse
